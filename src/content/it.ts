...
export const contentIT: PageContent = {
  ...
  pricing: {
    eyebrow: "Prezzi",
    title: "1% di commissione. 0 CHF fissi. 0 CHF setup.",
...
export const metaIT = {
  ...
  description: "Vendi voucher direttamente sul tuo sito. 1% di commissione. TWINT, Stripe & Wimag. Senza intermediari.",
};
